...
def root():
    ...
    return render_template(
        "index.html",
        pic=data["results"][randomint]["image"],
        name=data["results"][randomint]["name"],
    )
...
def tyler1():
    ...
    data = json.loads(res)
    return render_template(
        "tyler1.html", tylerData=data["query"]["pages"][0]["terms"]["alias"][0]
    )
...
def league():
    ...
    data = json.loads(res)
    return render_template("league.html", leagueData=data)
